...
export default function getShows() {
    return [{
        ...
        title: 'Breaking Bad',
        image: breakingBad,
        synopsis: `A high school chemestry teacher diagnosed with inoperable lung cancer turns to manufacturing and selling methamphetamine in order to secure his family's future.`
    }, {
        id: 'death-note',
        title: 'Death Note',
        image: deathNote,
        synopsis: `An intelligent high school stundet goes on a secret crusade to eliminate criminals from the world after discovering a notebook capable of killing anyone whose name is written into it.`
    }, {
        id: 'game-of-thrones',
